...
rem Fallback: download Git installer via curl (built-in Windows 10+)
...
if not exist "!GIT_INSTALLER!" (
    echo   Download failed. Please install Git from https://git-scm.com/download/win then re-run.
    pause
    exit /b 1
)
...
if not exist "!INSTALL_DIR!\.git" goto :clone
