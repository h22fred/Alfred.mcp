...
https://${DYNAMICS_BASE_URL}/main.aspx?etn=sn_engagement&id=<sn_engagementid>&pagetype=entityrecord
Never omit the link.`,
  {
    account_id:     z.string().describe("Dynamics account GUID"),
  ...
  async ({ account_id, type, name, notes, completed_date }) => {
    ...
    const link = `https://${DYNAMICS_BASE_URL}/main.aspx?etn=sn_engagement&id=${engagement.sn_engagementid}&pagetype=entityrecord`;
